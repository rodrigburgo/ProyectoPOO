...
/**
 * Clase que proporciona métodos para manejar archivos de entrada y salida, así como realizar la traducción de archivos.
 */
public class ManejadorArchivos {
     ...
     * @param outputFile la ruta del archivo de salida donde se guardará la traducción en formato Python.
     */
